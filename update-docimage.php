...
$imgnewfile=($imgfile);
// .$extension Code for move image into directory

move_uploaded_file($_FILES["image"]["tmp_name"]);
$imgpath="docimages/".$imgnewfile;
// Query for insertion data into database
$query=mysqli_query($con,"update document set path  ='$imgpath' where idDocument='".$_GET['did']."'");
if($query)
{
