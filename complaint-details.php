...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['Document_description']);?>
											</td>
											<td><b>Document Creation Date</b></td>
											<td> <?php echo htmlentities($row['Document_creation_date']);?></td>
											<td><b>Document Modified Date</b></td>
...
<tr>
											<td><b>Document Type Name </b></td>
											<td><?php echo htmlentities($row['documentTypeName']);?></td>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://110.37.224.211/DMS/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['idDocument']);?>');" title="Update Document">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<!-- <a href="javascript:void(0);" onClick="popUpWindow('http://110.37.224.211/DMS/admin/userprofile.php?uid=<?php echo htmlentities($row['idUsers']);?>');" title="Update Users">
