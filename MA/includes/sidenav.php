...
<?php endif;?>
 ...
 ?>                     
      ...
      <div class="form-group">
                ...
                <input type="text" name="creator" required="required" value="<?php echo htmlentities($row['Username']);?>" class="form-control" readonly>
                </div>  
                          </span>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						 ...
						 <input type="button" id="btnReset" value="Reset" class="btn btn-info btn-md" >
                            ...
                            <input type="text" class="form-control" name="coordinates" id="width"readonly>
                        </div>
