        ...
        <ul class="list-group">
            ...
            <li class="list-group-item sidebar-separator-title text-muted d-flex align-items-center menu-collapsed">
                ...
                <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <span class="menu-collapsed"><span class="menu-collapsed"><img src="assets/img/document-icon.png" width="20" height="20" alt="users-pic">
                    <form action="includes/insert.php" method="POST" >
                    <div class="form-group">
                <label for="template">Template Name:</label>
                <input type="text" class="form-control" name="temp" id="template">
            ...
            <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <span class="menu-collapsed"><img src="assets/img/logo.png" width="20" height="20" alt="users-pic"> Area 2 </span>
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">                <div class="form-group">
                <label for="sel1" >Detection Type:</label>
