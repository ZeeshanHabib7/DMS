...
// plus sign represnts the concatination
        ...
        return (typeof area.id === "undefined" ? "" : (area.id + ":"))
        + '<br />' + area.x + ':' + area.y  + '<br />'+ ' ' + area.width + 'x' + area.height + '<br />'
			}
...
<ul class="nav navbar-nav navbar-left">
      <li><a href="#"> <img src="assets/img/logo.png" width="30" height="30" class="d-inline-block align-top" alt=""></a></li>
...
<a class="navbar-brand" href="#"> DCMS</a>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="#"><img src="assets/img/logout.png" width="30" height="30" class="d-inline-block align-top" alt=""> LogOut </a></li>
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav" >
      <h4><img src="assets/img/logo.png" width="30" height="30" alt="users-pic"> Template Deisgner</h4>
      <hr>
