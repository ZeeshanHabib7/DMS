...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>DCMS | Document iforma</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-file-text-o"></i> Document informa</h3>
...
<div class="col-sm-4">
<input type="text" name="docName" required="required" value="" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">Document Author </label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Document Size</label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Document Type</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Document Version </label>
<div class="col-sm-4">
