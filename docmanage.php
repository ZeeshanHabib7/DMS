...
<html lang="en">
  <head>
    ...
    <title>DCMS | Manage Documents</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-file-text-o"></i> Documents</h3>
...
?>										
    ...
    <td><?php echo htmlentities($row['idDocument']);?></td>
      ...
      <td><?php echo htmlentities($row['Document_author']);?></td>
      <td><?php echo htmlentities($row['documentTypeName']);?></td>
      <td><?php echo htmlentities($row['Document_description']);?></td>
      ...
      <!-- <td><button type="button" class="btn btn-danger">Not process yet</button></td>
       -->
      <!-- <td>   <a href="complaint-details.php?cid=<?php echo htmlentities($row['idDocument']);?>"> View Details</a> 
      </td> -->
