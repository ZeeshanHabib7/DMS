...
<!-- 
<td><a href="javascript:void(0);" onClick="popUpWindow('http://110.37.224.211/DMS/admin/userprofile.php?uid=<?php echo htmlentities($row['idUsers']);?>');" title="View Details">
...
<button type="button" class="btn btn-danger" disabled >Delete</button></a> -->
										...
										<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/dms/admin/userprofile.php?uid=<?php echo htmlentities($row['idUsers']);?>');" title="View Details">
<button type="button" class="btn btn-primary">View Detials</button>
											</a>
<a href="manage-users.php?uid=<?php echo htmlentities($row['idUsers']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete ?')">
