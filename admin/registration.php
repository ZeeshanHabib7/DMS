...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into admin (username,password) values('$fullname','$password')");
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="User Name" name="fullname"  required="required" autofocus>
		            <br>
