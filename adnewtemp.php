...
if(isset($_POST['save_btn']))
{
    ...
    // {
        ...
        $filepath="tempimages/".$filename;

        move_uploaded_file($filetemp,$filepath);
        $query=mysqli_query($con, "call uploadtempimage('$filename', '$filepath', '$filetype')");
        if($query)
        {
            header('location:tmpNotProcessed.php');
...
<td> <label>:</label></td>
<td> <label><input type="file" name="img" required="required" autofocus/></label></td>
</tr>
<tr>
<td> <label></label></td>
<td> <label></label></td>
